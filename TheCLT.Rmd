...
The sample mean is `r mean(x.avg)`, and the standard deviation is `r sd(x.avg)`. The plot is starting to appear like a normal standard deviation plot. Standard deviation decreases the more we increase the sample size. 
